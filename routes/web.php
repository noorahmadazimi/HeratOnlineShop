...
use App\Http\Controllers\RecommenddController;
...
Route::post('/addRating',[RecommenddController::class,'addRating']);
Route::post('/productAddViews', [RecommenddController::class,'addView']);
Route::get('/facModel' , [RecommenddController::class, 'recommendedMethod']);