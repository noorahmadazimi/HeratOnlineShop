...
<head>
    ...
    <link href="{{ asset('rate.css') }}" rel="stylesheet">
            ...
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <div class="d-flex">
                        ...
                        <div class="pl-3 ml-3 pt-2" style="border-left:1px solid rgba(0, 0, 0, 0.5); font-size:1.5rem;">Herat-onLine Shop</div>
                    </div>
                </a>
            ...
            <div class='container p-0 pt-3'>
                <div class='row'>
                    <div class='col-md-4 col-sm-12 pt-3'>
                        ...
                        <p>Made by <br> Noor Ahmad Azimi <br> +93790790354 <br> noorahmadazime@gmail.com</p>
                    </div>
                    <div class='col-md-4 col-sm-12 pt-3'>
                        <h3>Follow Me On</h3>
                        <ul>
                    ...
                    <div class='col-md-6 col-sm-12 copyright'>
                        <p>Designed from scratch by Noor Ahmad Azimi</p>
                        <p>Herat_onLine Shop &copy; 2022. All Rights Reserved</p>
                    </div>
